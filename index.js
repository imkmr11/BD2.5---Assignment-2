...
function sortedStocksDesc(stock1, stock2) {
  return stock2.price - stock1.price;
}
function sortedStocksAsc(stock1, stock2) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  if (pricing === 'high-to-low') {
    sortedStocks = stocksCopy.sort(sortedStocksDesc);
  }
  if (pricing === 'low-to-high') {
    sortedStocks = stocksCopy.sort(sortedStocksAsc);
  }

  res.json(sortedStocks);
});

function sortedGrowthDesc(stock1, stock2) {
  return stock2.growth - stock1.growth;
}
function sortedGrowthAsc(stock1, stock2) {
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  if (growth === 'high-to-low') {
    sortedStocks = stocksCopy.sort(sortedGrowthDesc);
  }
  if (growth === 'low-to-high') {
    sortedStocks = stocksCopy.sort(sortedGrowthAsc);
  }
